...
libraryDependencies ++= Seq(
 "FruTTecH" %% "zio-event-sourcing" % "0.0.5",
 "FruTTecH" %% "zio-event-sourcing-serializer-protobuf" % "0.0.5",
 "FruTTecH" %% "zio-event-sourcing-file-store" % "0.0.5",
 "FruTTecH" %% "zio-event-sourcing-cassandra-store" % "0.0.5"
)
```
